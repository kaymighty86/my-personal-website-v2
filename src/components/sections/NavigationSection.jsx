...
export default function NavigationSection(){
    ...
    return (
        <>
            <button onClick={handleNavButtonClick} className={`${Styles.navButton}${navOpen? " "+Styles.navOpen: ""}`}>{!navOpen? <TiPointOfInterest/> : <LuCross />}</button>
            {navOpen && 
                <nav onClick={handleNavButtonClick} className={Styles.navigationSection}>
                    <ul>
                        <li><ActiveLink_Router to="/" underline><TiPointOfInterest/> Home</ActiveLink_Router></li>
                        ...
                        <li><ActiveLink_Router to="/#about" underline><TiPointOfInterest/> About</ActiveLink_Router></li>
                    </ul>
                </nav>
            }
        </>
